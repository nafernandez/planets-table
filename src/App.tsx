...
function App() {
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      <div 
        className="flex-shrink-0 opacity-100 gap-6 pt-6 pb-6 w-full max-w-[1265px] min-h-[78px] pr-4 sm:pr-[32px] pl-4 sm:pl-[32px] border-b flex flex-wrap items-center"
      >
